...
namespace StudentAdvisor.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private Register CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Register)}'. " +
                    $"Ensure that '{nameof(Register)}' is not an abstract class and has a parameterless constructor, or alternatively " +
